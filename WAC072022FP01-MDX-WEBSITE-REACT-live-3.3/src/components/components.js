...
import AboutIntroWidget from "./AboutIntroWidget";
...
const Components = {
  ...
  AboutIntroWidget: AboutIntroWidget,
  UpcomingEventWidget: UpcomingEventWidget,
  OurTeam: OurTeam,
  ...
  EventDayCard: EventDayCard,
  FacultyCard: FacultyCard,
  ImageBoxCard: ImageBoxCard,
  ImageContentBoxCard: ImageContentBoxCard,
  NewsUpdateCard: NewsUpdateCard,
  ImageDetailsCard: ImageDetailsCard,
  ProgramCard: ProgramCard,
  JobsCard: JobsCard,
  ProgramContentCard: ProgramContentCard,
  ...
  StatCard: StatCard,
  ImageBoxCardExpand: ImageBoxCardExpand,
  ReviewCard: ReviewCard,
  VideoEventCard: VideoEventCard,
  AboutPressOffice: AboutPressOffice,
  AccordionView: AccordionView,
  AnnouncementsWidget: AnnouncementsWidget,
  CourseStrip: CourseStrip,
  CourseTab: CourseTab,
  FacultyStack: FacultyStack,
  NewsListing: NewsListing,
  NewsUpdateCardStack: NewsUpdateCardStack,
  PhotoGallery: PhotoGallery,
  RecentStackSlider: RecentStackSlider,
  RecentStackWidget: RecentStackWidget,
  SportsTable: SportsTable,
  TableTabWidget: TableTabWidget,
  VerticalTabs: VerticalTabs,
  VideoEventCardSlider: VideoEventCardSlider,
  GridComponent: Grid,
...
const ComponentFunc = (block) => {
  if (block != undefined && typeof Components[block?.slug] !== "undefined") {
